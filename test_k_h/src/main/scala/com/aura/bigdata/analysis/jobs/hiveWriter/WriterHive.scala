...
object WriterHive {
  ...
  //返回数据集（元组）
  (point_code,point_name,rdd._2, datetime,hours, monitor_value,  type_code, eq_code,eq_name, data_type, warn_type,procedure_code,procedure_name)//,id
   })
  ...
  /**
    ...
    */
  def hive_influxdb(row:DStream[(String, String, String,String,String, String,String, String, String,String,  Int,String,String)] ,hivespark:HiveContext,tableming:String) ={//,ai_point_id_dt:String
     ...
     row.foreachRDD(rdd => {
      ...
      if (!rdd.isEmpty()) {
        ...
        val sql: RDD[Row] = rdd.map(
          str => {
            Row(str._1, str._2, str._3.toLong, str._4, str._5, str._6.toDouble, str._7, str._8, str._9, str._10, str._11, str._12,str._13)
          }
        )
        ...
        hivespark.sql("insert into table procedure_eq_point partition(eq_code,datetime) " +
                      "select point_code,point_name,time_long,hours,monitor_value,type_code ,eq_name,data_type," +
                      "warn_type,procedure_code,procedure_name,eq_code,datetime from mon_qdg_point_id_dt")
