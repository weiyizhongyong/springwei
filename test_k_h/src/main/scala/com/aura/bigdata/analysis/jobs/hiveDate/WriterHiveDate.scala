package com.aura.bigdata.analysis.jobs.hiveDate
...
object WriterHive {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val conf = new SparkConf().setAppName("test_mon").set("spark.kryo.registrator", "mysqlKafka.PiliangTest.IOServer.MyRegisterKryo")
