...
public class InfluxDBTemplate extends InfluxDBAccessor implements InfluxDBOperations<Point> {
    ...
    public InfluxDBTemplate(final InfluxDBConnectionFactory connectionFactory, final PointCollectionConverter<Point> converter) {
        setConnectionFactory(connectionFactory);
        setConverter(converter);
    }


    public void setConverter(final PointCollectionConverter<Point> converter) {
  ...
  /*  @Override
    public void write(Point... payload) {
    ...
    public void write(List<Point> payload) {
        final String database = getDatabase();
        final String retentionPolicy = getConnectionFactory().getProperties().getRetentionPolicy();//存储策略
